...
class DefinitionsControllerTest < ActionController::TestCase
  ...
  test "should create definition" do
    assert_difference('Definition.count') do
      post :create, definition: { constants: @definition.constants, constraints: @definition.constraints, fmt: @definition.fmt, variables: @definition.variables }
    end
  ...
  test "should update definition" do
    patch :update, id: @definition, definition: { constants: @definition.constants, constraints: @definition.constraints, fmt: @definition.fmt, variables: @definition.variables }
    assert_redirected_to definition_path(assigns(:definition))
  end
